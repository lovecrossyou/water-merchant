	...
	<view class="page-content">
		...
		<view class="statistics-content">
			<view class="statistics-item">
				<view class="statistics-item-size">150</view>
			...
			<view class="statistics-line"></view>
			<view class="statistics-item">
				<view class="statistics-item-size">43</view>
				<view class="statistics-item-name">新品</view>
			</view>
		</view>
		<view class="order-content">
			<view class="order-item"><view class="order-item-text">推荐</view></view>
