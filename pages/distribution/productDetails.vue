	...
	<view class="product_details_wrapper" ref="homPage" >
		...
		<view class="price-section">
			<view class="price-section-item">
				<view class="price">
					￥<span class="big">{{'12345'}}</span>
				</view>
				<view class="vip">
					<image :src="icon_vip"></image>
					<view class="original_price">市场价 ￥{{'123456'}}</view>
				</view>
			</view>
			<view class="price-section-item">
				<view>
					<image class="icon_fire" :src="icon_fire"></image>已抢{{'2222'}}件
				</view>
			</view>
		</view>
		<!-- 商品信息  -->
		<view class="product-info">
			<view class="product-info-title-wrap">
				<view class="product-info-title">
					<span class="pinkage">1折购</span>{{'3333'}}
				</view>
			</view>
			<view class="rule">
		...
		<view class="winning_periods">
			<view class="particulars_item">
				<view class="periods">第 {{'88888'}} 期</view>
		...
		<view class="winning_periods">
			...
			<view class="detail_imgurllist">
				<block v-for="(item,i) in [1,2,3,4,5]" :key="i">
	...
	export default {
		...
		computed: {
			...
			banners() {
				...
				return ['../../static/distribution/product_icon.png',
